            ...
            <g:form resource="${this.estudiante}" method="POST">
                <fieldset class="form">
                    <f:with bean="estudiante">
                        <f:field property="persona"/>
                        <f:field property="matricula"/>
                        <f:field property="carrera"/>
                        <f:field property="semestre"/>
                        <f:field property="grupo"/>
                        <f:field property="isActivo"/>
                        <f:field property="fechaIngreso"/>
                        <f:field property="fechaBaja"/>
                        <f:field property="fechaReingreso"/>
                    </f:with>
                </fieldset>
